...
- Summarize estimator behaviour and index conventions in the docstrings of whatever
  you touch under =metrics_miscellany/=.

* Communication
- Surface blockers immediately (missing dependency, sandbox limit, failing check) along with
