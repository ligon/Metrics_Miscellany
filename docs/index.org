...
=DataMat=/=DataVec= structures.  The documents are written in **Emacs Org-mode**.  The
Python package itself is plain Python: through 0.3.x the modules were tangled from a
literate Org source, which was retired in 0.4.0.
...
| 0.4.0 Reorganization  | [[file:reorg-0.4.0.org][reorg-0.4.0.org]]                           | Retiring the literate source: plan and decisions      |
